...
def iter(pmtu, todocols, todorows)
  ...
  puts("Run...")
  my_growth_matrix = my_run1.execute(my_old_matrix1, rows1, cols1)
...
# In zone 134 rijden mode=Auto, tijd=ochtendspits 234 auto's (coltotal) weg en er komen er 123 aan (rowtotals). 
